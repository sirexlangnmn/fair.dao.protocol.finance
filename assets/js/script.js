!(function (a) {
	...
	a('a.menu-link[href*="#"]:not([href="#"])').on("click", function () {
		if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
			...
			if ((e = e.length ? e : i).length) return a("html, body").animate({ scrollTop: e.offset().top - t }, 1e3, "easeInOutExpo"), !1;
		}
	});
	...
	if (x.length > 0) {
		...
		x.addClass("owl-carousel").owlCarousel({ items: 6, nav: !1, dost: !0, margin: 30, rtl: b, responsive: { 0: { items: 1 }, 400: { items: 2, center: !1 }, 599: { items: 3 }, 1024: { items: 4 }, 1170: { items: 5 } } });
	}
	...
	if (C.length > 0) {
		...
		C.addClass("owl-carousel").owlCarousel({ navText: [], items: 1, margin: 30, nav: !0, dost: !1, autoplay: !0, loop: !0, animateOut: "fadeOut", autoHeight: !0, rtl: y });
	}
	...
	if (z.length > 0) {
		...
		z.each(function () {
			...
			e.addClass("owl-carousel").owlCarousel({ navText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"], items: i, loop: r, nav: o, dots: d, margin: c, center: m, autoplay: n, autoplayTimeout: s, autoplaySpeed: 300, rtl: A, responsive: { 0: { items: 1 }, 480: { items: t }, 768: { items: l }, 1170: { items: i } } });
		});
	}
						...
						a(e).ajaxSubmit({
							...
							success: function (i) {
								...
								B.removeClass("alert-danger alert-success")
									...
									.html(i.message)
									.slideDown(400),
									"error" !== i.result && a(e).clearForm().find(".input-field").removeClass("input-focused");
							},
						});
				},
			}),
	...
	var O = "../ico/images/",
		...
		E = "../ico/",
		R = "../ico-user/";
	i.hasClass("is-rtl-delete") && ((O = "../../ico/images/"), (F = "LTR Mode"), (M = "../index-delete.html")),
		i.append(),
	...
	if (a(q).length > 0) {
		...
		a(q).addClass("owl-carousel").owlCarousel({ items: 1, nav: !1, dotsContainer: ".slider-nav,.slider-dot", margin: 30, loop: !0, autoplayTimeout: 3e3, rtl: G, autoplay: !0, animateOut: "fadeOut", autoplayHoverPause: !0 });
	}
	var I = a(".card");
	I.length > 0 &&
		I.each(function () {
		...
		N.length > 0 &&
			particlesJS("particles-js", {
				particles: {
					...
					color: { value: Z },
					shape: { type: "circle", opacity: 0.2, stroke: { width: 0, color: W }, polygon: { nb_sides: 5 }, image: { src: "img/github.svg", width: 100, height: 100 } },
					opacity: { value: 0.3, random: !1, anim: { enable: !1, speed: 1, opacity_min: 0.12, sync: !1 } },
				...
				interactivity: { detect_on: "canvas", events: { onhover: { enable: !0, mode: "repulse" }, onclick: { enable: !0, mode: "push" }, resize: !0 }, modes: { grab: { distance: 400, line_linked: { opacity: 1 } }, bubble: { distance: 400, size: 40, duration: 2, opacity: 8, speed: 3 }, repulse: { distance: 200, duration: 0.4 }, push: { particles_nb: 4 }, remove: { particles_nb: 2 } } },
				retina_detect: !0,
			});
})(jQuery);
